...
import { Briefcase, DoorClosed, DoorOpen, MapIcon, MapPinIcon, MapPinOff } from 'lucide-react';
...
const JobPage = () => {
  ...
  >
    ...
    <SelectContent>
      ...
      <MDEditor.Markdown
      source={job?.requirements} className='wmde-markdown bg-transparent sm:text-lg'
      />
